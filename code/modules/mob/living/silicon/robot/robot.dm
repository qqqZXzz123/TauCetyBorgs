...
/mob/living/silicon/robot/proc/pick_module()
	...
	switch(modtype)
		...
		if("Service")
			...
			module_sprites["ERP Service"] = "robot_erp_serv"
		...
		if("Miner")
			...
			module_sprites["ERP Miner"] = "robot_erp_mine"
			give_hud(DATA_HUD_MINER)
		...
		if("Medical")
			...
			module_sprites["ERP Medical"] = "robot_erp_med"
		...
		if("Security")
			if(can_be_security)
				...
				module_sprites["Security ERP"] = "robot_erp_syndi"
			else
		...
		if("Engineering")
			...
			module_sprites["ERP Engineering"] = "robot_erp_eng"
		...
		if("Janitor")
			...
			module_sprites["ERP Janitor"] = "robot_erp_jani"
