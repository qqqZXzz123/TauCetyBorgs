...
/obj/item/weapon/paper/capletter
	name = "Сообщение капитану"
	icon_state = "paper_words"

/obj/item/weapon/paper/capletter/atom_init()
	. = ..()
	info = pick("<h1><center>Сообщение из инженерного отдела МДКС 'Старый Воробей'</h1></center><hr> <br>Тот метеорит, что едва не протаранил карго, сильно истощил наши запасы стройматериалов. Нужно ли говорить, что если их срочно не пополнить, то станция рискует развалиться по частям. Станция уже давно не новая, поэтому нуждается в регулярном тех.обслуживании, а для этого нужны листы металла и панели стекол. Просим вас как можно скорее предоставить инженерному отделу недостающие материалы.",
	"<h1><center>Сообщение службы безопасности МДКС 'Старый Воробей'</h1></center><hr><br>Товарищ Капитан, я понимаю, что у Вас и без меня сейчас дел невпроворот, но всё же попрошу выслушать меня. В арсенале службы безопасности отсутствует летальное оружие. Я понимаю, что летальное вооружение на такой небольшой станции может звучать как нечто из ряда вон, однако я считаю что в случае возникновения непредвиденной ситуации,  сильное оружие значительно увеличит наши шансы на нейтрализацию угрозы. Также отмечу, что сам факт наличия летального оружия на станции значительно снижает шансы возникновения вышеупомянутых непредвиденных ситуаций. Я посчитал своим непременным долгом поделиться своими опасениями касательно безопасности станции с Вами. Поступайте с этой информацией так, как посчитаете нужным.<br><br><i>С уважением, офицер службы безопасности.</i>",
	"Капитан, поскольку у нас отсутствует штатный уборщик, пожалуйста, не забывайте назначать дежурного за уборку на станции. На прошлой смене был такой страшный бардак, а убирать его никто даже и не собирался, поэтому работать руками пришлось мне, а ведь у меня и без этого дел полно! Назначение дежурного одновременно обеспечивает чистоту на станции и позволяет экипажу не отвлекаться своих дел на уборку.<br><br><font size=1> Только, чур начинайте не с меня, мне вчерашней уборки хватило</font>",
	"<h1><center>Сообщение из медицинского отдела МДКС 'Старый Воробей'</h1></center><hr><br>Капитан, у нас кончаются пакеты с кровью. Предлагаю организовать донорскую акцию, либо же заказать пакеты через отдел снабжения.",
	"<h1><center>Сообщение из отдела снабжения МДКС 'Старый Воробей'</h1></center><hr><br>Эй, босс, нам бы это, экзокостюм для добычи, знаете ли. А то неудобно как-то. Минерало-добывающая станция и без минерало-добывающего оборудования... Пускай инженеры работой займутся и соберут нам его, а мы им накопаем чего.",
	"Капитан, кого вообще понабрали на эту станцию? Некоторые из так называемых 'членов экипажа внеземного происхождения' даже двух слов не могут связать на общем галактическом! Выпишите им азбуку что ли, пусть почитают-поучатся в свободное время. Я даже готов взять на себя роль учителя на некоторое время, при условии, что вы выпишите мне нормальный учебник.")
	updateinfolinks()

/obj/item/weapon/paper/engienote
	name = "Сообщение инженерному отделу"
	info = {"Вчера, прямо посреди ночи, за стеной моей каюты что-то очень громко гремело, а потом хлопнуло с такой силой, что мне показалось, будто внешнюю обшивку пробило. Кажется там что-то взорвалось.<br><br>Пожалуйста, почините там всё поскорее, второго падения с койки я, боюсь, не переживу"}

/obj/item/weapon/paper/cooknote
	name = "Сообщение повару"
	info = {"Уважаемый повар!<br><br>Прошу впредь не добавлять в ваши блюда мясо без спроса. Как минимум предупреждайте о том из чего состоит ваше блюдо ПРЕЖДЕ чем его подать.<br><br>На станции, к вашему сведению, могут быть вегетарианцы, которых оскорбляет подобное поведение. <br><br>Надеюсь, что вы с пониманием отнесётесь к этому сообщению."}

/obj/item/weapon/paper/maintenancenote
	name = "Записка"
	info = {"Уважаемые члены экипажа, гуляющие по техническим тоннелям.<br><br>Напоминаю вам, что эти тоннели нужны для корректной работы вентиляционной и мусоропроводной системы.<br><br>Тоннели позволяют инженерам проводить обслуживание транспортных труб и вовремя устранять возникающие поломки. Наличие у гражданского персонала доступа в техничесские тоннели <u>обусловлено соображениям безопасности</u>.<br><br>НО ЭТО НЕ ЗНАЧИТ ЧТО ВАМ МОЖНО ЗДЕСЬ ШНЫРЯТЬСЯ. ПОСТОРОННИМ ВХОД СЮДА <u>ЗАПРЕЩЕН</u>. <br>ХВАТИТ ПРИНОСИТЬ СЮДА ВСЯКИЙ ХЛАМ И РАССТАСКИВАТЬ ИЗ ТЕХНИЧЕСКИХ ХРАНИЛИЩ ИНСТРУМЕНТЫ.<br><br><br><br><font size=1><i>попробуй останови меня</i></font>"}

/obj/item/weapon/paper/sadnote
	name = "Старая записка"
	info = {"Словами не описать, как сильно мне тебя не хватает."}

/obj/item/weapon/paper/sadnote2
	name = "Старая записка"
	info = {"Не сегодня."}

/obj/item/weapon/paper/sadnote3
	name = "Пыльная записка"
	info = {"Не забывайте поливать это растение дважды в неделю."}

/obj/item/weapon/paper/creepynote1
	name = "Старая подгоревшая записка"
	info = {"Мы сделали это... Мы... должны были это сделать... Это было ужасно и отвратительно. Но мы сделали это. Сила взрыва была достаточно мощной, чтобы сместить ближайшие астероиды. От этой хрени ни осталось ничего. Совсем ничего. Даже пыли. Записи и те были стерты по приказу капитана. Никто никогда не узнает об этом. Оно мертво для всей вселенной, как будто этого никогда и не было. Мы сделали всему миру большое одолжение, избавив его от этого ужаса. Но оно не ушло бесследно. Оно поселилось в наших воспоминаниях. То, что я видел... оно навсегда останется со мной. Оно будет преследовать меня в темноте, являться ко мне в кошмарах. В последние мгновения своей жизни, я буду вспоминать... <b>ЭТО</b>."}

/obj/item/weapon/paper/creepynote2
	name = "Старая рваная записка"
	info = "Я видел этот взрыв собственными глазами, но лишь толики сомнения, лишь шальной мысли, что хоть что-то могло уцелеть достаточно, чтобы холодный пот выступил на моей спине, а по всему телу пробежали мурашки. Мы столкнулись с чем-то, что никогда не должно было существовать. Сейчас от него ни осталось ничего. Мы тщательно уничтожили все доказательства его существования. Единственное, что могло бы подтвердить реальность увиденного мною в ту смену - кратер на астероиде. Но я слишком труслив, чтобы пойти и проверить есть ли он там. Я буду молить Господа, чтобы это оказался лишь кошмарный сон. Быть может, когда-нибудь я и сам в это проверю"

/obj/item/weapon/paper/mednote
	name = "Старая записка"
	info = {"Босс, я же предупреждал, что автоматизированный завод и искусственный интеллект - вещи несовместимые.<br>Но нет, зачем нам слушать старого венерианца, давайте оставим всё как есть.<br>И вот, пожалуйста! Поступил, значит, несколько часов назад сигнал о какой-то угрозе с подстанции ИИ. Я, разумеется, пошел проверять что там да как.<br><br>Скажу вам вот что: вы можете сколько угодно обвинять нас в недальновидности, предвзятости к синтетикам и даже суеверии... но кое в чем, мы всё таки правы: доверить ИИ контроль над системой безопасности - всё равно, что дать обезьяне фороновую бомбу!<br>Эта кибер-гнида с дури выдумала себе угрозу, напечатала боевого дрона и благополучно сдохла.<br>Всё бы хорошо, да этот её роботизированный утырок теперь гуляет вокруг её подстанции и шмаляет по всем без особых раздумий. Железный обосранец и в меня попал.<br>С горем пополам перекрыл ему проход к Воробью. Дальше сами с ним разбирайтесь - я умываю руки.<br><br>Вините в этом кого хотите: хоть проектировщика, который решил, что этой подстанции тут самое место, хоть робототехников, которые эту тварь программировали - только не меня! Я вам сразу говорил, что ИИ до добра не доведет.<br><br>И вообще, с меня хватит! Как только заживут раны я сваливаю на первом попавшемся шаттле.<br>Счастливо оставаться."}

/obj/item/weapon/paper/byeletter
	name = "Старое письмо"
	info = {"Привет дружище, давно не виделись.<br><br>
Слышал у тебя в последнее время одни неприятности и сейчас ты активно ищешь где бы залечь на дно, пока все не уляжется. Так вот, есть у меня одно такое местечко на примете. Крошечная астероидная станция на самом отшибе системы в участке астероидного поля, некогда считавшимся перспективным. Как это часто бывает, спустя время нашли участок поперспективнее, вбухнули туда станцию поновее, а про старую забыли с концами, что нам с тобой только на руку.
<br><br>Сейчас на станцию отправляют либо вчерашних выпускников, либо ксеносов, которых на нормальные станции отправлять стыдно, либо особо провинившихся перед корпорацией сотрудников, так что думаю ты впишешься. По контракту экипаж туда закидывают сразу на несколько месяцев, так что приходится и каюту с кем-то делить и шваброй работать - всё таки уборщиков там нет, так что полы моют все по очереди.
<br><br>В общем, местечко не самое плохое, если не учитывать, что построили его хрен знает когда. О современном оборудовании можно и не мечтать, а о развлечениях тем более. Если не боишься скиснуть от скуки на старом корыте - твой верный друг и товарищ готов помочь перебраться туда так, чтобы об этом никто никогда не узнал.
<br><br>Учитывая твои обстоятельства, я бы не затягивал с решением. Надеюсь, ты ещё помнишь как со мной связаться.<br><br>
<font size=1> Думаю, не нужно говорить, что после этого <u>мы в расчете</u></font>"}

/obj/item/weapon/paper/sciencenote1
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[23:15] Начало записи.
	<br>[23:15] День... э-э-э... Семнадцатый? Нет, погоди-ка...
	<br>[23:16] Двадцать первый...?
	<br>[23:16] Блин, плохо дело, календарь бы... Завтра спрошу точную дату у кого-нибудь на станции.
	<br>[23:17] Как раз припасы кончаются... Заодно и в душ схожу.
	<br>[23:18] В любом случае... Я тут кое-что провернул, спешу похвастаться.
	<br>[23:19] После небольших махинаций, у меня таки вышло измерить плотность образцов, собраных рядом с местом столкновения.
	<br>[23:20] Плотность первых образцов составляет приблизительно три с половиной грамма на кубический сантиметр.
	<br>[23:20] Сомнений нет - то, что я держу сейчас у себя в руках - настоящий алмаз. Да ещё какой.
	<br>[23:21] Однако несколько кристаллов измерить не удаётся - находящееся у меня оборудование попросту не подходит для такой деликатной структуры.
	<br>[23:21] Предположительно, это телекристаллы, но их форма вызывает у меня сомнения... Нужно провести больше исследований.
	<br>[23:22] Собственно, рассказать больше нечего. А хотя нет, есть кое-что...
	<br>[23:22] Пока зашивал свой скафандр, решил, так сказать, укрепить его из тех образцов, что не годятся в исследования. Уж не знаю, насколько получилось практично но смотрится... Как минимум интересно.
	<br>[23:23] Ну вот на этом точно всё, услышимся зав.. не понял. Что за хрень?
	<br>[23:23] Что это?! Нет! Твою мать! Оно прорывается! Не трожь! Стой!! А-а-а!! А-а-а!!
	<br>[23:24] Не-е-ет!! Пожалуйста! А-а-ах! А-а-а!! Твою мать! Н-не-е-ет-т...
	<br>[23:24] А-а-а-а-а-а!!!
	<br>[23:25] ...
	<br>[23:30] ...
	<br>[23:40] ...
	<br>[23:50] ...
	<br>[00:00] ...
	<br>[00:15] Конец записи."}

/obj/item/weapon/paper/sciencenote2
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[22:38] Начало записи.
	<br>[22:38] Ксеноархеологический отчет о недавнем столкновении астероида В-ТК-29 и МДКСН Старый Воробей.
	<br>[22:39] День первый. Результат осмотра места столкновения.
	<br>[22:39] В-ТК-29 прошел через добрую треть астероида МДКСН, прежде чем окончательно расколоться на несколько фрагментов.
	<br>[22:40] Место столкновения усеяно осколками В-ТК-29, образцами местых и неместных пород. Виднеются большие и малые кристаллические образования.
	<br>[22:41] Что из этого было здесь до столкновения, а что прилетело с В-ТК-29 ещё только предстоит узнать.
	<br>[22:41] На возведение аванпоста и установку оборудования уйдет дня три-четыре. Некоторе время придется пожить на станции. Очень устал.
	<br>[22:42] Конец записи."}

/obj/item/weapon/paper/sciencenote3
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[23:52] Начало записи.
	<br>[23:52] Ксеноархеологический отчет. День второй.
	<br>[23:52] С самого утра общался с местным контенгентом, распрашивал их о столкновении.
	<br>[23:52] Люд здесь, конечно, очень общительный. Говорили много, о всяком. О чем угодно, только не о недавнем столкновении.
	<br>[23:53] Но что-то узнать у них мне всё-таки удалось.
	<br>[23:53] Для начала, один из шахтеров за бутылку пива рассказал мне о ярком свечении, которое он видел с поверхности астероида МДКСН. По его словам, свет исходил как будто бы из челнока, но был в несколько раз ярче.
	<br>[23:54] Потом интервью согласились дать местный повар и медбрат... или медсестра... я так и не понял.
	<br>[23:54] По словам первого, тряска по полу прошла такая, что было слышно, как в каютах лопались доски, а с полок попадали тарелки. Что мне прокряхтел второй я так толком и не понял, но выглядел он крайне возмущенным.
	<br>[23:54] Где-то ближе к концу рабочих суток вернулись шахтеры и инженеры, что работали над моим аванпостом. Последние, много бубнели по поводу лишней работы, что обрушилась на их головы с моим прибытием, но со временем охладили свой пыл и вместе с шахтерами поделились своими находками.
	<br>[23:55] Несмотря на мой четкий указ ничего не трогать в районе столкновения, они таки натащили на станцию осколков В-ТК-29.
	<br>[23:56] В прочем, времени рассмотреть их у меня не было - оставшуюся часть вечера мы провели за барной стойкой. Я посчитал уместным отблагодарить местных работяг выпивкой, как говорится, на халяву.
	<br>[23:56] Они же, в свою очередь, посчитали уместным отблагодарить меня крайне насыщенной историями, былыми воспоминаниями и байками беседой до самой ночи. Хотя я не могу сказать о них ничего плохого. Наоборот, в целом, довольно приятные ребята.
	<br>[23:57] Завтра займусь тем, что осмотрю принесенные мне образцы... если сушняк не замучает...
	<br>[23:58] Конец записи."}

/obj/item/weapon/paper/sciencenote4
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[22:34] Начало записи.
	<br>[22:34] Ксеноархеологический отчет. День третий.
	<br>[22:34] По правде говоря, до сегодняшнего дня я не верил, что сила столкновения была настолько мощной, чтобы встряхнуть весь астероид.
	<br>[22:35] Но один из инженеров подтвердил слова повара заявив, что колебания, вызванные столкновением двух космических тел действительно дошли до станции и даже вызвали... как бы выразиться технически... неожиданное напряжение в структуре станции....}
	<br>[22:36] В прочем, он же и поспешил заверить меня в надежности станции. По его словам, этот старый воробей переживет всех нас, как пережил тех, кто был до нас.
	<br>[22:37] Как по мне, его возраст внушает скорее страх, чем доверие. По современным меркам его можно смело назвать древним, если не доисторическим.
	<br>[22:38] Так, ладно, теперь к тем камушкам, которые вчера притащили. После визуального осмотра стало яс...
	<br>[22:38] <i>Ты это про меня</i>?
	<br>[22:38] Что?
	<br>[22:38] ...
	<br>[22:38] <i>Это ты про меня</i>?
	<br>[22:39] ...
	<br>[22:39] Нет?
	<br>[22:39] ...
	<br>[22:39] Я говорил про образцы, собранные вчера вокруг зоны столк...
	<br>[22:39] <i>Просто если ты про меня, то было бы как-то не ловко и даже обидно, чувак</i>.
	<br>[22:39] ...
	<br>[22:40] Я говорил про станцию.
	<br>[22:40] ...
	<br>[22:40] ...
	<br>[22:41] И-и-и... Он просто ушел.
	<br>[22:41] То есть вот так, взял и ушел.. ни сказав не слова.
	<br>[22:41] ...
	<br>[22:42] Мда...
	<br>[22:43] Конец записи."}

/obj/item/weapon/paper/sciencenote5
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[22:23] Начало записи.
	<br>[22:23] День пятый. Решил не записывать события вчерашнего дня. Да и в целом, скорее всего не буду больше делать ежедневные отчеты. Это отвлекает от работы.
	<br>[22:23] Наконец-то переехал на аванпост. Весь день устанавливал и настраивал оборудование. С завтрашнего дня займусь сбором образцов местных и неместных пород.
	<br>[22:24] А сейчас, уж простите, пора бы и обжить, так сказать, новое местечко... отпраздновать успешный переезд и все такое, хе-хе-хе...
	<br>[22:24] М-м! Ох, хорошо пошла. Жаль, что закусить нечем.
	<br>[22:25] Конец записи."}

/obj/item/weapon/paper/sciencenote5
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[07:18] Начало записи.
	<br>[07:18] Нет туалета!! Почему на этом аванпосте никто не додумался установить туалет?!
	<br>[07:18] Конец записи."}

/obj/item/weapon/paper/sciencenote6
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[22:03] Начало записи.
	<br>[22:03] День седьмой. Наконец-то мои руки дошли до документирования своих находок. Что ж, спешу ими поделиться!
	<br>[22:03] Ух, даже не знаю, с чего начать. Наверное, с того, что расскажу об абсолютно революционном открытии.
	<br>[22:04] Те большие синие кристаллы, что прилетели на астероид МДКСН вместе с В-ТК-29 способны самостоятельно передвигаться!
	<br>[22:04] Мне не удалось выяснить, каим образом они это делают, но дистанции, которые они способны преодолевать в течении суток - поражают. Самый дальний от места столкновения кристалл был всего лишь в сорока метрах от станции.
	<br>[22:05] А станция находится на вообще другой стороне астероида! Поразительно!
	<br>[22:06] Также отмечу, что тот кристалл отличается от остальных своими размерами, что наталкивает меня на гипотезу... думаю, что чем кристалл больше, тем дальше он может перемещаться.
	<br>[22:06] Думаю и дальше отслеживать перемещения самого большого кристалла. Чтобы было проще, я предлагаю дать ему рабочее название... или даже имя... Пусть будет Джордж. Да.
	<br>[22:07] Как именно они перемещаются, мне ещё предстоит узнать. Те, что поменьше, я решил отнести на аванпост и исследовать поподробнее.
	<br>[22:07] Был неприятно удивлен, когда на следующее утро они пропали. Вернее.. я думал, что они пропали. На самом деле, они, подобно Джорджу, переместились в разные уголки аванпоста.
	<br>[22:08] Их постоянные перемещения, пока я сплю, значительно затрудняют их изучение...
	<br>[22:08] Стыдно признавать, что некоторые из них за ночь просто исчезли - я так и не смог найти, куда они подевались.
	<br>[22:09] Благо, место столкновения всё ещё усеяно осколками этих синих кристаллов.
	<br>[22:10] А значит работы ещё много! А это значит, что мне нужно хорошенько отдохнуть... денёк-другой...
	<br>[22:11] Конец записи."}

	/obj/item/weapon/paper/sciencenote7
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[15:18] Начало записи.
	<br>[15:18] День девятый!! Эврика!!
	<br>[15:18] Синие кристаллы телепортируются! Я видел собственными глазами!!
	<br>[15:18] Джордж! Он сделал это на моих глазах, когда я нашел его к северу от солнечных панелей! Я просто смотрел на него, моргнул, и он исчез!
	<br>[15:18] Вот так! Взял и исчез! Без звуков или вспышек или чего-либо ещё! Исчез и появился в другом месте!
	<br>[15:19] За свой рывок он совершил перемещение в десять метров! Где это видано, чтобы кусок синего камня не обладающий разумом вот так взял и сместился на десять метров?!
	<br>[15:19] Это не просто кристаллы! Это... Это телекристаллы!! Ах-ха-ха-ха!! Кристаллы, которые телепоритруются! Телекристаллы! Ха-ха-ха-ха!!
	<br>[15:19] Я назову их телекристаллами и никто мне ничего не сделает! Я их нашел! Я их нашел и я дам им название!! Телекристаллы! Да-а-а!! Ха-ха-ха-ха!!!"
	<br>[15:20] Конец записи."}

/obj/item/weapon/paper/sciencenote8
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[21:49] Начало записи.
	<br>[21:49] День девятый... э-э-э... Запись вторая?
	<br>[21:49] Быстрая радость также быстро сменилась паникой. Джордж пропал. То есть.. совсем пропал. Он и раньше совершал прыжки через весь астероид, но сегодня, я боюсь, он прыгнул куда-то совесем далеко.
	<br>[21:49] Словно психопат, я оббродил весь астероид в поисках Джорджа, но так и не нашел его... Более того, те кристаллы, что были в зоне столкновения сейчас уже разбрелись по всему астероиду.
	<br>[21:50] Это не хорошо. Это чертовски не хорошо. Поверить не могу, но у меня так и не получилось их подробно изучить, хотя прошло уже почти десять дней!
	<br>[21:50] Они просто.. сбегают от меня! Даже самые маленькие кристаллы способны запросто сбежать с аванпоста, стоит мне отвернуться от них.
	<br>[21:51] Боюсь, что чтобы зафиксировать их, мне придется их раскрошить.
	<br>[21:51] Прозвучит антинаучно, но мне кажется это неправильно... что если они.. ну.. живые?
	<br>[21:51] Они способны передвигаться... Сколько тысячалетий мы думали, что камни неодушевленые объекты не могут передвигаться по своей прихоти?
	<br>[21:52] Чего ещё об этих чудесных кристаллах мы не знаем? Не будет ли варварством разрушать то, что мы не создали? В одно мгновение ничтожить то, что складывалось естественным образом на протяжении тысячалетий?
	<br>[21:52] Ух.. мне надо.. мне надо всё обдумать... и выпить... мне точно нужно выпить.
	<br>[21:52] Конец записи."}

/obj/item/weapon/paper/sciencenote9
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[22:13] Начало записи.
	<br>[22:13] День двенадцатый. Джордж так и не вернулся.
	<br>[22:13] Смейтесь сколько угодно, но я вот уже три дня пытаюсь выйти с телекристаллами на контакт.
	<br>[22:14] Безуспешно.
	<br>[22:14] Но я не сдамся. Если есть хотя бы малейший шанс, что эти кристаллы на самом деле живые организмы, я буду делать всё, что в моих возможностях, чтобы нанести им как можно меньше вреда.
	<br>[22:15] И хотя я не считаю их живыми организмами в привычном для нас понимании этого термина, я не могу отрицать, что в них может протекать какая-то когнитивная, биологическая или даже эзотерическая активность!
	<br>[22:15] Они уже дали нам понять сполна, что привычные нам термины в принципе не справляются со своими функциями, когда дело касается описания телекристаллов.
	<br>[22:16] Я не могу позволить себе даже рискнуть навредить... им.
	<br>[22:16] Конец записи."}

/obj/item/weapon/paper/sciencenote10
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[22:07] Начало записи.
	<br>[22:07] День пятнадцатый. За последние три дня Джордж так и не был обнаружен.
	<br>[22:07] Я... я... сделал ужасное.
	<br>[22:08] Эти чертовы телекристаллы... как только у меня удалось убедить себя в собственном идиотизме и смириться с тем, что большие синие камни - всего лишь большие синие камни, они решили доказать мне обратное.
	<br>[22:08] Я.. я решил отколоть от одного из них фрагмент, чтобы изучить его подробнее и..
	<br>[22:09] Он напал на меня.. если это можно назвать нападением.. я.. я уже не знаю как это называть... моего словарного запаса не хватает, чтобы описать, с чем я имею дело каждый день... можно ли это в принципе описать словами?
	<br>[22:09] Стоило моей кирки каснуться кристалла, как меня ослепило яркое свечение исходящее из кристалла. Некоторое время я не мог видеть.
	<br>[22:09] Когда ко мне вернулось зрение, я был в совершенно другом месте. Телекристалл телепортировал меня, в ответ на мой удар.
	<br>[22:10] И если этого не достаточно, чтобы поверить, что у них есть разум... у меня есть ещё кое-что.
	<br>[22:10] После случившегося каждый телекристалл начал реагировать на моё приблежение. Стоит мне приблизиться к любому из них, как он начнет вибрировать и светиться.
	<br>[22:11] Я не замечал за ними такого поведения раньше. Что это может значить? Угроза? Страх? Они пытаются меня прогнать? Запугать? Что бы то ни было, я уверен в одном и меня это вовсе не радует - у них есть разум. При чем коллективный.
	<br>[22:12] Они вышли со мной на контакт. И они мне не рады.
	<br>[07:18] Конец записи."}

/obj/item/weapon/paper/sciencenote11
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[22:03] Начало записи.
	<br>[22:03] День двадцать... первый? С момента исчезновения Джорджа прошла неделя.
	<br>[22:03] Целая неделя безрезультатных попыток наладить контакт с телекристаллами.
	<br>[22:04] Кристаллы реагируют на вибрации. Вот и всё, что я могу вам о них рассказать. Я пытался всячески перед ними извиниться, за тот... случай.
	<br>[22:04] Но всё тщетно! Вообще всё! Танцевал рядом с ними, включал им мелодии, пел им песни, играл на скрипке! Всё бестолку! Они по прежнему меня боятся. По прежнему злобно вибрируют на меня, когда я к ним подхожу.
	<br>[22:05] Мне не остается ничего кроме как.. попытаться добыть их снова.. я должен сделать это, чтобы понять, как они устроены. Я не хочу их убивать. Но они не оставили мне выбора.
	<br>[22:05] Завтра я снова возьму в руки кирку.
	<br>[22:06] Конец записи."}

/obj/item/weapon/paper/sciencenote12
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[23:48] Начало записи.
	<br>[23:48] ...
	<br>[23:48] ...
	<br>[23:49] ...
	<br>[23:50] День двадцать второй. Джордж не объявился.
	<br>[23:50]	...
	<br>[23:51] ...
	<br>[23:51] ...
	<br>[23:52] Я добыл фрагменты телекристаллов.
	<br>[23:52]	Конец записи."}

/obj/item/weapon/paper/sciencenote13
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[22:01] Начало записи.
	<br>[22:01] День двадцать пятый. Джордж не объявлялся.
	<br>[22:02] Реакция телекристаллов на меня ослабевает если я ношу с собой их фрагменты. Чем больше маленьких фрагментов, тем слабее реакция.
	<br>[22:02] Если носить их на виду, то могут вовсе никак не реагировать.
	<br>[22:03] ...
	<br>[22:03] Сегодня, в поисках новых фрагментов наткнулся на местную фауну. Скафандр придется заштопать.
	<br>[22:03] ...
	<br>[22:04] Обычно они не водятся в этой части астероида.
	<br>[22:04] Конец записи."}

/obj/item/weapon/paper/sciencenote14
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[22:27] Начало записи.
	<br>[22:27] День двадцать девятый. Никаких следов Джорджа.
	<br>[22:27] Телекристаллы стали встречаться реже. Зато чертовы чудовища, что местные называют голиафами - чаще.
	<br>[22:28] Чертовы твари подкрадываются всё ближе к месту столкновения. Если так продолжится, то мне придется длить с ними свой маленький аванпост.
	<br>[22:28] Между тем, собранных мною фрагментов хватает на эксперименты с лихвой. Мне удалось стабилизировать осколки путем термической обработки.
	<br>[22:29] Больше они не телепортируются.
	<br>[22:29] Конец записи."}

/obj/item/weapon/paper/sciencenote15
	name = "Расшифровка"
	info = {"<b>Расшифровка.</b>
	<br><br>[23:02] Начало записи.
	<br>[23:02] День двадцать... Тридцать.. не знаю...
	<br>[23:02] Я не знаю...
	<br>[23:03] Чего хотят от меня эти кристаллы - не знаю. Чего от них хочу я - не знаю.
	<br>[23:03] Знаю, что скафандр опять надо штопать. И что проклятые твари уже совсем близко - знаю.
	<br>[23:04] Надо сваливать с этого аванпоста. Ничего у меня не получается. Бухло кончается. Идеи кончаются. Фрагменты не кончаются.
	<br>[23:04] Их у меня уже так много, что хоть хрустальный замок строй.
	<br>[23:04] Конец записи."}
