...
/obj/item/weapon/paper/sciencenote1
	...
	<br>23:15 День... э-э-э... к черту...
	<br>23:16 Я Хочу покинуть этот аванпост.
	<br>23:16 Я уже исследовал всё, что только мог. Я больше не хочу вредить телекристаллам.
	<br>23:17 Нам никогда их не понять.
	<br>23:18 Ни когда в наблюдение регулярно вмешивается местная живность...
	<br>23:19 И ни когда их единственный наблюдатель - пьяный ксеноархеолог.
	<br>23:20 Нужно запросить оборудование получше.
	<br>23:20 Да...
	<br>23:21 Пусть этим ханимаются ксенобиологи, или ксеносоциологи... да хоть ксенофилософы! Кто угодно! Только не я. С меня хватит.
	<br>23:21 Меня не покидают мысли, что я всё испортил.
	<br>23:22 Я смотрю на свой скафандр и не понимаю, на что я смотрю.
	<br>23:22 С одной стороны, они больше не видят во мне врага... с другой стороны, этот скафандр украшен остатками их братьев.
	<br>23:23 Насколько это правильно вообще?
	<br>23:23 Я не знаю.. я просто устал об этом думать! Я... я... не понял.
	<br>23:24 Что-то шкрябает по.. о нет.. Нет! Прочь! Прочь!!
...
/obj/item/weapon/paper/sciencenote6
	...
	<br>22:05 Также отмечу, что тот кристалл отличается от остальных своими размерами, что наталкивает меня на гипотезу... думаю, что чем кристалл больше, тем дальше он может перемещаться.
	...
	<br>22:11 Ну и последнее наблюдение. Заметил, что почва астероида МДКСН способна пропитываться кислородом и даже меняет свой окрас при продолжительном контакте с воздухом. Какие-то грибы даже расти начинают, мне кажется.
